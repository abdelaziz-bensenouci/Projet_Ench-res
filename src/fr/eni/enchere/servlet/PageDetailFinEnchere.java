 ...
 */
@WebServlet("/PageDetailFinEnchere")
public class PageDetailFinEnchere extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public PageDetailFinEnchere() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("/WEB-INF/DetailFinEnchere.jsp").forward(request, response);
